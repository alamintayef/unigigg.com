...
return [
     ...
     */
    'from' => [
        'address' => env('MAILGUN_FROM_ADDRESS', 'tayef@unigigg.com'),
        'name'    => env('MAILGUN_FROM_NAME', 'Tayef'),
    ],
     ...
     *
     */
    'reply_to' => env('MAILGUN_REPLY_TO', 'tayef@unigigg.com'),

    /*
     * Mailgun (private) API key
     *
     */
    'api_key' => env('MAILGUN_SECRET', 'key-20a16c60b0ed7d606d1e5143563dfb3f'),

    /*
     * Mailgun public API key
     *
     */
    'public_api_key' => env('MAILGUN_PUBLIC', 'pubkey-a01cdf6219031f780c7d1b91b9d10e08'),

    /*
     * Domain name registered with Mailgun
     *
     */
    'domain' => env('MAILGUN_DOMAIN', 'www.unigigg.com'),
