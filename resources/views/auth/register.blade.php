...
body
    {
      background: url(https://s24.postimg.org/frevtxjed/o4_yygi5jbc_glen_noble.jpg) no-repeat center center fixed;
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2" style="padding:50px;">
            <div class="card card-raised panel">
                <div class="panel-heading center"><h3>Hello, Talent!</h3></div>
