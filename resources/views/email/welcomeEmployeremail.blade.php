...
<head>
	...
	<title>Hello - Welcome Email</title>
                    ...
                    <tr>
                        <td align="center">
                            ...
                            <table width="400" cellpadding="0" cellspacing="0" border="0" class="container">
                                <tr>
                                    <td width="400" class="mobile" align="center" mc:label="the_logo" mc:edit="the_logo">

                                        <img src="https://s12.postimg.org/tl0klj4lp/unigigg_200px.png" width="200" height="200" style="margin:0; padding:0; border:none; display:block;" border="0" class="centerClass" alt="" mc:edit="the_image" />
                            ...
                            <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                                <tr>
                                    <td width="600" class="mobile" align="center" mc:label="the_banner" mc:edit="the_banner">
                                        ...
                                        <img src="http://www.clker.com/cliparts/3/4/6/9/13111954551462092168welcome.png" width="400" height="250" style="margin:0; padding:0; border:none; display:block; border-radius:8px;" border="0" class="imgClass" alt="" mc:edit="the_image" />
                            ...
                            <table width="800" cellpadding="0" cellspacing="0" border="0" class="container">
                                <tr>
                                    <td width="800" class="mobile" style="font-family:arial; font-size:18px; line-height:24px;" align="center" mc:label="the_title" mc:edit="the_title">
                                        Hello <span style="color:#40a7ff;"><strong>[{{$data['name']}}</strong></span>,<br>

                                        Welcome and thank you for joining Unigigg. We are glad that you choose unigigg as your choice for recruitment platform,
                                        the first thing you’ll want to do is build up your profile and let us help you to hire better candidates easily .<br>

                                        I would love to hear more about how you’re using Unigigg. We’re here to build an amazing experience. If you have any questions or comments please knock us on facebook at wwww.facebook.com/unigigg<br>
...
If you do NOT wish to receive these marketing updates you can unsubscribe from your unigigg dashboard.
                                ...
                                <tr>
                                    <td width="600" class="mobile" style="font-family:arial; font-size:12px; line-height:18px; color:#aeaeae;" align="center" mc:label="the_copyright" mc:edit="the_copyright">
                                        ...
                                        &copy; 2016 Unigigg. - All Rights Reserved
