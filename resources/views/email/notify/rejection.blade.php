                            ...
                            <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                                <tr>
                                    <td width="600" class="mobile" align="center" mc:label="the_banner" mc:edit="the_banner">
                                        ...
                                        <img src="http://vignette3.wikia.nocookie.net/clubpenguin/images/6/64/CPNext_Emoticon_-_Sad_Face.png/revision/latest?cb=20140214222421" width="400" height="400" style="margin:0; padding:0; border:none; display:block; border-radius:8px;" border="0" class="imgClass" alt="" mc:edit="the_image" />
                            ...
                            <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                                <tr>
                                    <td width="800" class="mobile" style="font-family:arial; font-size:18px; line-height:24px;" align="center" mc:label="the_title" mc:edit="the_title">
                                      ...
                                      Thanks for applying through unigigg.com and your interest in the position of <b> {{$user->job_name}}</b> <br>

                                      We are sorry to inform you that the employer reviewed your skills and experience and have decided to proceed with other candidates who met employer needs more accurately for the post.<br>
                                      ...
                                      Wish you the best of luck in your job hunt and thank you again for choosing unigigg.com <br>
