    ...
    <div class="panel panel-default">
      <div class="panel-heading"><a class="btn btn-primary  btn-lg" data-toggle="collapse" href="#collapse6">Add Hobbies</a></div>
    ...
    <div class="form-group">
      {!! Form::label('hobbies_related_work', 'Why This Hobby ? :', ['class' => 'control-label']) !!}
