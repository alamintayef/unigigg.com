      ...
      <div class="panel-heading" role="tab" id="headingTwo">
        <h4 class="panel-title">
          <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
            Why apply through Unigigg when I have my university career center?
          </a>
        </h4>
      </div>
      <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
        <div class="panel-body">
          Bangladeshi Universities are swamped with students and so are their career centers. You don’t get the preference for choosing the jobs that you want. These career centers typically offers certain types of internship or jobs. But here in Unigigg your preference is our utmost priority. We are proud to offer a more diverse selection of jobs. From typical 9-5 jobs to eccentric jobs we have them all. In Unigigg you build up your profile and showcase your skills and experiences to build up an attractive CV. We are here to help you stan out from the other applicants from the career centers.
        </div>
      </div>
    </div>
    <div class="panel panel-default">
    ...
    <div class="panel panel-default">
      <div class="panel-heading" role="tab" id="heading4">
        <h4 class="panel-title">
          ...
          What types of internships and jobs are available?
          </a>
        </h4>
      </div>
      ...
      <div class="panel-heading" role="tab" id="heading5">
        <h4 class="panel-title">
          <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse5" aria-expanded="false" aria-controls="collapseThree">
            What are the resources available to me as a candidate?
          </a>
        </h4>
      </div>
